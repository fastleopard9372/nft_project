      ...
      <div className='card px-0'>
        <div className='card-body px-0'>
          <div className=' pt-10 grid-cols-1 gap-6'>
                ...
                <div className='grid grid-cols-12 gap-5'>
                  <div className='col-span-7 grid grid-cols-2 gap-5'>
                    <div className='col-span-1 text-left'>
                      <img src='/profile/Rectangle 53.png' className='w-height'></img>
                    </div>
                    <div className='col-span-1'>
                      <img src='/profile/Rectangle 54.png' className='w-height'></img>
                    </div>
                  </div>
            ...
            <div className='grid grid-cols-3 gap-4 py-24' style={{ margin: '-8px' }}>
